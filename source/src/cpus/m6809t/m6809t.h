...
#define M6809T_CC_C  0x01  /* Carry */
#define M6809T_CC_V  0x02  /* Overflow */
#define M6809T_CC_Z  0x04  /* Zero */
#define M6809T_CC_N  0x08  /* Negative */
#define M6809T_CC_I  0x10  /* IRQ mask */
#define M6809T_CC_H  0x20  /* Half carry */
#define M6809T_CC_F  0x40  /* FIRQ mask */
#define M6809T_CC_E  0x80  /* Entire state saved */

typedef struct m6809t_state_S {
 ...
 */
extern uint8_t m6809t_read(m6809t_state *s, uint16_t addr);
extern void m6809t_write(m6809t_state *s, uint16_t addr, uint8_t val);

/* Separate opcode read for Konami-1 decryption support */
extern uint8_t m6809t_read_opcode(m6809t_state *s, uint16_t addr);
